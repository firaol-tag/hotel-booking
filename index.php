    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - SOLJAM HOTEL | <a href="https://www.sourcecodester.com/" target="_blank">wara software</a></div></div>
        </footer>
